		...
		guide: {
			vi: {
				body: "   {pn} <nick name>: thay đổi biệt danh của bản thân"
					...
					+ "\n\n   Ví dụ: (xem ảnh)",
				attachment: {
					[`${__dirname}/assets/guide/setname_1.png`]: "https://i.ibb.co/355jjBm1/283946a408d7.jpg",
					[`${__dirname}/assets/guide/setname_2.png`]: "https://i.ibb.co/355jjBm1/283946a408d7.jpg"
				}
			},
			en: {
